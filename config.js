...
//
global.Owner = ["+94740423674",];         //If you want singal number so global.Owner = ['916297175943'] Change into your number.
global.OwnerNumber = ["+94740423674",];   //If you want singal number so global.Owner = ['916297175943'] Change into your number.
global.ownertag = ["+94740423674"];
global.OwnerName = "DILANA";
global.BotName = "HIRU BOT";
global.packname = "🦋 │𝐂𝐘𝐁𝜩𝐑│𝐏𝜟𝐍𝐃𝐀│𝐌𝐃│𝐕➂ 🦋";                             //Do not change.
global.author = "NOTY_DILA";                               //Do not change.
